...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { bio: @actor.bio, date_of_birth: @actor.date_of_birth, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { bio: @actor.bio, date_of_birth: @actor.date_of_birth, name: @actor.name } }
