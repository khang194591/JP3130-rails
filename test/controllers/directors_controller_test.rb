...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { bio: @director.bio, date_of_birth: @director.date_of_birth, name: @director.name } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { bio: @director.bio, date_of_birth: @director.date_of_birth, name: @director.name } }
